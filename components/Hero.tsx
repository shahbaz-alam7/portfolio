      ...
      <div className="container mx-auto px-6 pt-40 pb-20">
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 justify-center md:justify-start cursor-pointer">
              <a
          ...
          >
            <div className="relative w-64 h-64 md:w-96 md:h-96 mx-auto">
              <div className="absolute inset-0 p-2 flex justify-center items-center rounded-full bg-gradient-to-r from-purple-600 to-blue-600 animate-pulse" />
              <Image
                src="/assets/image.jpg"
                alt="Profile Picture"
                width={400}
                height={400}
                className="rounded-full relative z-10 object-contain p-1"
                priority
              />
            </div>
          </motion.div>
